...
from trading_logic import DecisionFilter, DecisionContext
...
class TradingBot:
    ...
    def __init__(self, execute_orders: bool = False):
        ...
        # Initialize trading decision filter (context-aware signal qualification)
        self.trading_filter = DecisionFilter()
        ...
        for generator in generators_to_run:
            try:
                ...
                if signal:
                    ...
                    final_action, reason = self.trading_filter.qualify(
                    ...
                    if signal.metadata is None:
                        signal.metadata = {}
                    signal.metadata["trading_filter_reason"] = reason
